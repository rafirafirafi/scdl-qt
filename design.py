...
"}")
        ...
        self.cBox.setGeometry(QtCore.QRect(450, 130, 162, 17))
        ...
        self.mp3Box.setGeometry(QtCore.QRect(450, 150, 167, 17))
        ...
        self.rBox.setGeometry(QtCore.QRect(450, 170, 94, 17))
        ...
        self.saveButton.setGeometry(QtCore.QRect(610, 250, 81, 21))
        ...
        self.logTextEdit.setGeometry(QtCore.QRect(10, 120, 431, 201))
        palette = QtGui.QPalette()
        ...
        self.speedLabel.setGeometry(QtCore.QRect(360, 300, 81, 20))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 0, 127))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
